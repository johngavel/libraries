...
#define ARDUINO_IDE_LICENSE LICENSE_ADD("Arduino IDE", "Ver. 2.3.3", "")
#define RASPBERRY_PICO_LICENSE LICENSE_ADD("Arduino-Pico", "Ver. 4.4.1", "Pico_LICENSE")
#define ADAFRUIT_BUS_LICENSE LICENSE_ADD("Adafruit BusIO", "Ver. 1.17.0", "BusIO_LICENSE")
#define ADAFRUIT_GFX_LICENSE LICENSE_ADD("Adafruit GFX Library", "Ver. 1.11.11", "GFX_license.txt")
#define ADAFRUIT_MCP4725_LICENSE LICENSE_ADD("Adafruit MCP4725", "Ver. 2.0.2", "")
#define ADAFRUIT_PIXEL_LICENSE LICENSE_ADD("Adafruit NeoPixel", "Ver. 1.12.4", "NeoPixel_COPYING")
#define ADAFRUIT_SSD1306_LICENSE LICENSE_ADD("Adafruit SSD1306", "Ver. 2.5.13", "SSD1306_license.txt")
...
#define I2C_EEPROM_LICENSE LICENSE_ADD("I2C_EEPROM", "Ver. 1.9.2", "I2C_EEPROM_LICENSE")
#define TCA9555_LICENSE LICENSE_ADD("TCA9555", "Ver. 0.4.1", "TCA9555_LICENSE")
#define TERMINAL_LICENSE LICENSE_ADD("Terminal", "Ver. 1.0.3", "Terminal_license.txt")
