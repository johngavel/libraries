...
#define RASPBERRY_PICO_LICENSE LICENSE_ADD("Arduino-Pico", "Ver. 3.9.4", "Pico_LICENSE")
#define ADAFRUIT_BUS_LICENSE LICENSE_ADD("Adafruit BusIO", "Ver. 1.16.1", "BusIO_LICENSE")
#define ADAFRUIT_GFX_LICENSE LICENSE_ADD("Adafruit GFX Library", "Ver. 1.11.10", "GFX_license.txt")
