...
#define RASPBERRY_PICO_LICENSE LICENSE_ADD("Arduino-Pico", "Ver. 3.9.5", "Pico_LICENSE")
...
#define ADAFRUIT_SSD1306_LICENSE LICENSE_ADD("Adafruit SSD1306", "Ver. 2.5.12", "SSD1306_license.txt")
...
#define I2C_EEPROM_LICENSE LICENSE_ADD("I2C_EEPROM", "Ver. 1.9.0", "I2C_EEPROM_LICENSE")
#define TCA9555_LICENSE LICENSE_ADD("TCA9555", "Ver. 0.3.2", "TCA9555_LICENSE")
#define TERMINAL_LICENSE LICENSE_ADD("Terminal", "Ver. 1.0.1", "Terminal_license.txt")
