...
static const LibraryInfo libraries[] = {
    ...
    {"Adafruit GFX Library", "1.12.6", "Adafruit_GFX_Library_license.txt", AdafruitGFXLibrarylicense,
    ...
    {"Adafruit NeoPixel", "1.15.5", "Adafruit_NeoPixel_COPYING", AdafruitNeoPixelCOPYING, AdafruitNeoPixelCOPYING_len,
...
#define RASPBERRY_PICO_LICENSE LICENSE_ADD("Arduino-Pico", "5.7.0", "Pico_LICENSE", -1)
